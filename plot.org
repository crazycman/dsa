...
**** TODO [#A] Thalionmel Enttaeuschung [0/2]
     - [ ] Baxxe ::
...
****** ueber Branwen [6/14]                                            :info:
      ...
      - [ ] [[file:npcs.org::*Infos von Graustein][Infos von Graustein]]
      - [ ] [[file:npcs.org::#ss1-info][Simiadane ueber Branwen]]
      - [ ] [[file:npcs.org::#ha1-info][Hemwit ueber Travigod & Branwen]]
      - [ ] [[#im-goldbutt][im Goldbutt]]
      - [ ] [[#die-seiler][die Seiler]]
      - [ ] [[#an-seekadettenschule][an der Seekadettenschule]]
      - [ ] so ne Fischersfrau, die [[file:npcs.org::*Travigod Gawain][Travigod]] hat zuletzt mehrfach lautstark auf "die Hexe" geflucht
