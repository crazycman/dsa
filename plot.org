...
***** Hesindetempel
      CLOSED: [2020-12-21 Mo 22:20]
***** TODO [#A] Grausteins Plan [0/4]
      - [ ] Necker sind Kinder Efferds; *friedlich*
      - [ ] herausfinden: was treibt sie an? warum sind sie aggressiv?
      - [ ] Schluessel dazu: [[file:npcs.org::#YB1][Ybalio]] (Heimliche Befreiungsmission); [[file:npcs.org::#BH1][Branwen]]; *mehr Infos* sammeln
      - [ ] Ausruestung
        - [ ] [[https://ulisses-regelwiki.de/index.php/Seg_Gl%C3%BCckssegen.html][Glueckssegen]] +1 FP in den naechsten 12 Stunden
        - [ ] 2 faustg Gwen-Petryl Steine (Licht in 2 Schritt Radius)
        - [ ] [[file:items.org::#item-tiefendorn][Tiefendorn]]
***** TODO [#A] wo ist Branwen
      <2020-12-30 Mi>
****** ueber Branwen [8/15]                                            :info:
      ...
      - [ ] das ist ne Hex! Die treibt sich Abends wer weiss wo, und tagsueber in der Unterstadt rum!
      - [ ] [[file:npcs.org::#gs1-info][Infos von Graustein]]
      - [ ] [[file:npcs.org::#ss1-info][Simiadane ueber Branwen]]
      - [X] [[file:npcs.org::#ha1-info][Hemwit ueber Travigod & Branwen]]
      - [ ] [[#im-goldbutt][im Goldbutt]]
...
****** die Furien vom Fischerort [0/1]                                 :info:
       ...
       - [-] Gruppe von Frauen um [[file:npcs.org::*Travigod Gawain][Travigod]] die auf "die Hexe [[file:npcs.org::#BH1][Branwen]]" schimpfen
         - [X] Die spannt uns doch die Maenner aus (Etaine, Hanni)
         - [ ] hext sie zu Schlappschwanz (Ailbe)
****** im Goldbutt [0/4]
       :PROPERTIES:
       ...
       - [ ] [[file:npcs.org::#BH1][Branwen]] war vor drei Abenden hier
       - [ ] ein Junge Frau ([[file:npcs.org::#HG1][Hanni Glennard]]) hat die den ganzen Abend ueber finster beobachtet
       - [ ] die Junge war ein paar mal hier in Begleitung eines schmucken Seekadetten ([[file:npcs.org::#HA1][Dunval Ardheg]])
       - [ ] zwischen denen ist es aber wohl aus, der ([[file:npcs.org::*Dunval Ardheg][Dunval Ardheg]]) ist jetzt mit anderen Liebchen
****** die Seiler [0/2]
       :PROPERTIES:
       :CUSTOM_ID: die-seiler
       :END:
       Seiler *Brodan* kann berichten:
       - [ ] [[file:npcs.org::#TG1][Travigod]] war hier, ja.
...
****** an der Seekadettenschule [0/5]
       ...
       - [ ] vor allem bei [[file:npcs.org::#HA1][Dunval Ardheg]] schmilzt das junge Weibsvolk dahin
...
***** TODO [#A] Nebelgeister Konterbande uebergabe [0/4]
      - [ ] Ihr schueffelt ja ganz schoen im Fischerdorf rum?
      ...
      - [ ] Was war den da auf der Rethis los?
      ...
      - [ ] [[file:npcs.org::#qu-konterbande][Queste : Konterbande aus Unterstad bergen]]
      - [ ] Wollt ihr weiter mit uns arbeiten? habt ihr eine Idee/Anliegen? *Toter Briefkasten*
** Wetter
   :PROPERTIES:
   :CUSTOM_ID: wetter
   :END:
