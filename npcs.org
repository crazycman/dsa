...
*** Simiadane ueber Branwen [0/3]                                      :info:
    :PROPERTIES:
    :CUSTOM_ID: ss1-info
    :END:
    - [ ] Befreundet mit [[#BH1][Branwen]]; diese ist mit [[*Ybalio][Ybalio]] dem Necker liiert
    - [ ] Branwen war vor 4 Tagen hier und wollte [[file:plot.org::#unter-wasser][Wasserodem]] kaufen (verboten)
          wollte dann weiter nach Fischerort
    - [ ] in einem Lagerhaus im Suedhafen steht die *Tiefensucher*
...
*** Graustein Infos [2/6]                                              :info:
    ...
    - [ ] Branwen war zuletzt vor 4 Tagen im Tempel und betetet fuer eine verschollene Person
    - [ ] vor einer Weile kam eine aufgeloeste Fischerin names [[#TG1][Travigod Gawain]]
    ...
    - [ ] was bringt die Necker dazu, sich so aggressiv zu verhalten?
...
*** Hemwit ueber Travigod & Branwen [0/3]                              :info:
    :PROPERTIES:
    :CUSTOM_ID: ha1-info
    :END:
    - [ ] [[*Travigod Gawain][Travigod]]? Ne du, bleib mir mit bloss mit der alten Zippe gestohlen!
...
** Travigod Gawain
   ...
   - [ ] [[*Branwen, die Hexe][Branwen]] ist eine Hexe die in die Moorburg gehoert! Sie verhext meinen Mann!
   - [ ] Keine Ahung wo sich das Weib rumtreibt, wahrscheinlich in der Unterstadt abgesoffen!
** Hanni Glennard
   :PROPERTIES:
   :CUSTOM_ID: HG1
   :SEX:      w
