...
**** TODO Begegnung mit der anderen Soeldnergruppe
     :PROPERTIES:
     :custom_id: 4
     :location: MA OR NA
     :layer: GN
     :END:
*** Unterfluren
**** TODO Redaktionshaus Havena-Fanfare & Dreikronen-Drukerei
     :PROPERTIES:
     :custom_id: UF11
     :location: G14
     :layer: GN
...
**** DONE Treffen mit Nebelgeistern 
     ...
     - Schmuggel auf dem Nebelpfad wird immer schwerer
       ...
       - [[file:organizations.org::#VG1][Vogtgarde]] und Schlaegertrupps (der [[file:organizations.org::#SH1][Die Silberne Hand]]?) mach Jagd aus uns
*** Fischerort
