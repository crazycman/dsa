...
*** Vergnügungsschiff Rethis
    ...
    :END:
**** Personen
     - [[file:npcs.org::#AA1][Asa Anjuhal]] Wirtin
     - [[file:npcs.org::#TH1][Tote Hand]] Croupier
     - [[file:npcs.org::#PN1][Phederino du Novara]] Heiler & Babier (Magier)
     ...
     - [[file:npcs.org::#BI1][Bilanil]] Neckersklave
*** Schatzinsel
    :PROPERTIES:
    :custom_id: G25
    :typ:      Ga
