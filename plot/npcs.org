...
** Domnall Dalpert
   ...
   - Hintergrund ::
     ...
     - Steckenpferd ist die grosse Flut: Er glaubt, dass sie - wie bei Selem -
       ...
       *Häufung von fallendem Gwen Petryl möglicherweise eineneue Flut ankündigt*
   - Ziele ::
...
*** Info [0/3]
    ...
    - [ ] Bibliothek:
      ...
      - [ ] Infos ueber Necker in historischen Werken:
...
*** Info [0/4]
    ...
    *Allgemein zu Neckern*
    ...
    - [ ] Vollmondlicht macht sie aggresiv
** Ybalio
   :PROPERTIES:
   :CUSTOM_ID: YB1
   :SEX:      m
