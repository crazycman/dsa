...
** Aeltestenrat
   ...
   :END:
   - Symbol/Erkennungszeichen :: 
   - Wahlspruch :: Fuer die Stadt & den Fuersten.
   - Herkunft: :: Havena
   - Größe :: 35 Mitglieder
   - Hierarchie :: streng
   - Wichtige Personen ::
     - [[file:npcs.org::#RN1][Rhonwin ui Notorn]]
     - [[file:npcs.org::*Cumal Ongswin][Cumal Ongswin]]    
   - Stützpunkte :: [[file:locations.org::#OF05][Stadthaus]]
   - Domänen ::
     - Handel, Stadtplanung & Verkehr
     - [[#SG1][Stadtgarde]]
   - Zusammenhalt, Beziehungen, Finanzkraft :: 3/5/5

   Im Ratssaal des Stadthauses tagt mindestens einmal im Monat der Ältestenrat von Havena.
   Das Stadtparlament ist weitgehend autonom für die Verwaltung der Stadt zuständig.
   Ihm obliegen die Belange des Handels, der Stadtplanung und des Verkehrs,
   außerdem untersteht ihm die Stadtgarde.   
   Der Rat hat 35 Mitglieder, vor allem aus den Reihen einflussreicher Patrizier, der Gilden und der Zünfte.
   Bereits im Jahr 618 v.BF soll der Rat erstmalig unter den Bragoldfürsten einberufen worden sein.
   In den Dunklen Zeiten lenkte er sogar die Geschicke der Stadt und des gesamten Umlands.
